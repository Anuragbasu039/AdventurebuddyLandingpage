...
const Stats = () => {
  ...
  return (
    <div className="container">
      <div className="item">
        <span ref={el => countersRef.current.push(el)} className="counter" data-target="10"></span>+ Schools
      </div>
      <div className="item">
        <span ref={el => countersRef.current.push(el)} className="counter" data-target="4000"></span>+ Students
      </div>
      <div className="item">
